...
class NewsContentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        try {
            ...
            throw BrehyException("Error inflating NewsContentFragment layout", e)
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            throw BrehyException("Error displaying news content", e)
        }
    }
    ...
    private fun showContent() {
        try {
            ...
            throw BrehyException("Error setting up WebView content", e)
        }
    }
}
